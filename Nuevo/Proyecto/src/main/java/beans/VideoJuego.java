...
private Compania compania;
  ...
  public VideoJuego(int idJuego, String titulo, String descripcion, String trailer, Date fecha, double precio, Compania compania, Imagen imgCover, Imagen imgCoverMobile, Imagen imgBanner, ArrayList<Plataforma> plataformas, ArrayList<Genero> generos, ArrayList<Personaje> personajes) {
  ...
  // Metodo que devuelve un string con la fecha 
